...
public class TwitchApiTask implements Runnable {
    ...
    public void run() {
            ...
            if (Config.Value.FOLLOW_NOTIFICATION) {
                ...
                TwitchAPI.checkRecentFollowers();

            }

        LogHelper.info("Existing Followers (Updated): "+TwitchAPI.existingFollowers);
        LogHelper.info("Notification Queue: "+TwitchAPI.notificationQueue);
